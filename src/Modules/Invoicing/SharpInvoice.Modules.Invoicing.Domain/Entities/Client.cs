...
public sealed class Client : Entity<Guid>
{
    ...
    public void UpdateContactInfo(string? email, string? phone) { Email = email; Phone = phone; }
    public void UpdateAddress(string? address, string? country, string? locale) { Address = address; Country = country; Locale = locale; }
